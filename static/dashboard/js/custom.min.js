    ...
    var t, a, n, l, i, s, o, c, r, d, u, h, f, m, v, p, g, b, k, C, z, y, $, w, x, F = (t = e(window).width(), a = function () {
        ...
        if (jQuery(".dz-theme-mode").length > 0) {
            jQuery(".dz-theme-mode").on("click", function () {
                jQuery(this).toggleClass("active"), jQuery(this).hasClass("active") ? (jQuery("body").attr("data-theme-version", "dark"), setCookie("version", "dark"), jQuery("#theme_version").val("dark")) : (jQuery("body").attr("data-theme-version", "light"), setCookie("version", "light"), jQuery("#theme_version").val("light")), e(".default-select").selectpicker("refresh")
            });
            var t = getCookie("version");
            jQuery("body").attr("data-theme-version", t), jQuery(".dz-theme-mode").removeClass("active"), setTimeout(function () {
        ...
        init: function () {
            a(), n(), i(), s(), o(), c(), r(), l(), d(), u(), h(), m(), v(), f(), b(), g(), z(), k(), C(), p(), y(), $(), x()
        },
        load: function () {
            p()
        }
